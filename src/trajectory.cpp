...
void Trajectory::computeDesired() {
    ...
    m_desiredPosition(0,0)= m_radius*sin(m_angularSpeed*m_time_s+th0);
    m_desiredPosition(1,0)= m_radius*cos(m_angularSpeed*m_time_s+th0);
}
...
const Eigen::Vector2f Trajectory::getDesiredPosition()
{
